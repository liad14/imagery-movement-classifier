...
if(strcmp(typeOfClassifier,"extended"))
    featureTable = array2table(featuresMatrixNormalized,'VariableNames',{'VARC3','VARC4','freq18C3','freq18C4','highCloudC3','highCloudC4','freq10C3','freq10C4','SEC3','SEC4','approximateEntropyC3','approximateEntropyC4','PSstdC3','PSstdC4','PSmeanC3','PSmeanC4'});
else
